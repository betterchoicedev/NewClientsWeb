...
const OnboardingModal = ({ isOpen, onClose, user, userCode, companyName, companyConfig }) => {
  ...
  const MEAL_ORDER_EN = ['Breakfast', 'Morning Snack', 'Brunch', 'Lunch', 'Afternoon Snack', 'Dinner', 'Evening Snack', 'Late Dinner', 'Post-Workout Meal', 'Midnight Snack'];
  ...
  // Usage-based support: prod_TrcVkwBC0wmqKp, price_1SyHX0HIeYfvCylDZyb1Lb3L — 26+ days in a row = free
